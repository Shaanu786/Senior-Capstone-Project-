...
export class TaskService 
{
    ...
    {
        console.log(`getting user task for ${user}`);
        return this.appTasks.filter(task => task.user === user);
    }
...
export const tasks: Task[]= [
  {title:"Take Quiz 03",description:"Review modules 02 & 03",project:"Project 2",status:"todo",due:" November 12th, 2019",user:"Chris Barrera",taskid:"1"},
  ...
  {title:"Implement Command Interface", description:"Implement the command design pattern to Project 4", project:"Project 2", status:"progress", due:"11/25/19",user:"Faraz",taskid:"4"},
  {title:"Lab Activity 08",description:"Create an ArcScene Map",project:"Project 4",status:"finished",due:" November 18th, 2019",user:"Shaan Barkat",taskid:"5"},
  ...
  {title: "Work on stylized css sheet", description: "Create the style.css sheet to connect to frontend", project: "Project 3", status: "progress", due: "10/14/19",user:"Collin De Kalb",taskid:"10"}
]
